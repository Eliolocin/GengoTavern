						...
						<div className="input-section">
							...
							<div className="form-group">
								...
								<textarea
									...
									placeholder="e.g., 'Use internet information about Shinosawa Hiro to generate her character.', 'Generate the Scenario, Greeting, and Sample Dialogues in full Japanese', 'Make the character a chronically online boy failure', 'Use simple vocabulary only as I am still learning Spanish'..."
									maxLength={500}
